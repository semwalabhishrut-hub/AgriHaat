    ...
    <AppShell>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pb-6 border-b border-[#E2E7E2]">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 rounded-full border border-[#16803A]/30 bg-[#EEF7EF] px-4 py-2 text-xs font-bold text-[#16803A] hover:bg-[#16803A] hover:text-white transition shadow-2xs"
          >
            <Sparkles className="size-3.5" />
            {lang === "hi" ? "AI सहायक से पूछें" : "Ask AI Copilot"}
          </button>
          <Link
      ...
      <div className="mt-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-5">
          ...
          <div className="rounded-2xl border border-[#E2E7E2] bg-white p-4 sm:p-5 shadow-xs">
            ...
            <p className="mt-3 text-2xl font-bold text-[#172019]">500 kg</p>
          ...
          <div className="rounded-2xl border border-[#E2E7E2] bg-white p-4 sm:p-5 shadow-xs">
            ...
            <p className="mt-3 text-2xl font-bold text-[#172019]">3 Active</p>
            <p className="mt-1 text-[11px] text-[#16803A] font-semibold">1 pickup tomorrow</p>
          </div>
          ...
          <div className="rounded-2xl border border-[#E2E7E2] bg-white p-4 sm:p-5 shadow-xs">
            ...
            <p className="mt-1 text-[11px] text-[#687D6B]">T+1 payout on delivery</p>
          </div>
          ...
          <div className="rounded-2xl border border-[#E2E7E2] bg-white p-4 sm:p-5 shadow-xs">
            ...
            <p className="mt-3 text-lg font-bold text-[#172019] truncate">Tomorrow</p>
            <p className="mt-1 text-[11px] text-[#16803A] font-semibold">10:30 AM (Token #42)</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-12">
          ...
          <div className="rounded-3xl border border-[#E2E7E2] bg-white p-5 sm:p-7 shadow-xs">
            ...
            <div className="mt-5 grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
              <div className="rounded-xl bg-[#FAFAF7] p-3 border border-[#E2E7E2]">
                <span className="text-[#687D6B]">Nearby Buyer Range</span>
                <p className="mt-1 text-base font-bold text-[#172019]">₹30 – ₹34/kg</p>
              </div>
              <div className="rounded-xl bg-[#FAFAF7] p-3 border border-[#E2E7E2]">
                <span className="text-[#687D6B]">Expected Demand</span>
                <p className="mt-1 text-base font-bold text-[#172019]">18,400 kg</p>
              </div>
              <div className="rounded-xl bg-[#FAFAF7] p-3 border border-[#E2E7E2] col-span-2 sm:col-span-1">
                ...
                <p className="mt-1 text-base font-bold text-[#16803A]">87% High</p>
              </div>
            </div>
            ...
            <div className="mt-4 rounded-2xl border border-[#16803A]/20 bg-[#EEF7EF] p-4 flex items-start gap-3">
              ...
              <div className="text-xs">
                <p className="font-bold text-[#172019]">
                  {lang === "hi"
                    ? "सिफारिश: चेन्नई में होटल और रेस्तरां मांग बढ़ रही है। अतिरिक्त ग्रेड A टमाटर लिस्ट करने पर विचार करें।"
          ...
          <div className="rounded-3xl border border-[#E2E7E2] bg-white p-5 sm:p-7 shadow-xs">
            ...
            <div className="mt-5 space-y-3 text-xs">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3.5 rounded-2xl bg-[#FAFAF7] border border-[#E2E7E2] gap-2">
                <div>
                  <p className="font-bold text-sm text-[#172019]">Tomatoes · 500 kg (Grade A)</p>
                  <p className="text-[#687D6B]">Buyer: ABC Grand Hotels & Restaurants</p>
                </div>
                <div className="sm:text-right">
                  <span className="rounded-md bg-[#EEF7EF] px-2 py-0.5 text-[11px] font-bold text-[#16803A]">
                    Status: Confirmed
                  </span>
                  <p className="mt-1 text-[#687D6B]">Pickup: 29 Aug · 8:30 AM</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="rounded-xl border border-[#E2E7E2] p-3">
                  ...
                  <p className="font-bold text-[#172019]">₹40/kg (Total ₹20,000)</p>
                </div>
                <div className="rounded-xl border border-[#16803A]/20 bg-[#EEF7EF] p-3">
                  <span className="text-[#687D6B]">Your Estimated Realization:</span>
                  <p className="font-bold text-[#16803A]">₹36/kg (Total ₹18,000)</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-5 flex justify-end border-t border-[#E2E7E2] pt-4">
              ...
              >
                Track this order <ArrowRight className="size-3.5" />
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          {/* Section D: Procurement Status (PS 26032 Integration) */}
          <div className="rounded-3xl border border-[#E2E7E2] bg-white p-5 sm:p-6 shadow-xs">
            ...
            <div className="mt-4 space-y-3 text-xs">
              <div>
                <p className="font-bold text-[#172019]">Kanchipuram District Centre</p>
              ...
              <div className="rounded-2xl bg-[#FAFAF7] p-3.5 border border-[#E2E7E2] space-y-2">
                <div className="flex justify-between">
                  <span className="text-[#687D6B]">Booked Slot:</span>
                  <span className="font-semibold text-[#172019]">Tomorrow · 10:30 AM</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#687D6B]">Queue Position:</span>
                  <span className="font-bold text-[#16803A]">8 farmers ahead</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#687D6B]">Estimated Wait:</span>
                  <span className="font-semibold text-[#172019]">~42 min</span>
                </div>
                <div className="flex justify-between border-t border-[#E2E7E2] pt-2">
                  <span className="text-[#687D6B]">Status:</span>
                  <span className="font-bold text-[#16803A]">Slot Confirmed</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              >
                View Procurement Pass <ArrowRight className="size-3.5" />
              </Link>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-[#16803A]/30 bg-[#EEF7EF] p-5 sm:p-6 shadow-xs">
            ...
            <h4 className="mt-2 font-serif text-base font-bold text-[#172019]">
              {lang === "hi"
                ? "आपकी टमाटर लिस्टिंग वर्तमान खरीदार रेंज से ₹2/किलो नीचे है।"
